...
class ServicePage(tk.Frame): 
    def __init__(self, parent, controller):
        ...
        self.home_button.pack(side="left", padx=(15, 0))
        ...
        self.image_label.grid(row=1, column=0, pady=(40, 10))
        ...
        self.book_button = tk.Button(self, text="Book Appointment", command=self.book_appointment, width=30, font = ("Helvetica", 15),)
        self.book_button.grid(row=5, column=0, pady=20)
